...
WebUI.click(findTestObject('AddNew/AddNew'))

WebUI.verifyElementPresent(findTestObject('NewPage/NewTitle'), 3)

WebUI.setText(findTestObject('NewPage/NewTitle'), 'Mi Nueva Pagina')

WebUI.click(findTestObject('NewPage/button_Publish'))
