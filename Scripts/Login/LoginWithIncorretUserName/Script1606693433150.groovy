...
'Se ingresa el usuario incorrecto'
WebUI.setText(findTestObject('Login/InputUserName'), 'opensourcecm')
...
'Se busca el mensaje de error del ingreso de usuario\r\n'
WebUI.verifyElementPresent(findTestObject('Error User/InvalidUser'), 3)
